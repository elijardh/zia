  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      decoration: new InputDecoration(
        ...
        labelText: label,
        labelStyle: TextStyle(color: labelColor ?? XColors.primaryColor.withOpacity(0.4), fontWeight: FontWeight.w400),
      ),
      style: const TextStyle(color: XColors.primaryColor, fontWeight: FontWeight.w400, fontSize: 16),
    );
  }
}
